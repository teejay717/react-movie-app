...
useEffect(() => {
  ...
  return (
    ...
    {loading ? 
        ...
        : 
        <div className='mx-50 flex flex-row justify-center items-center border-1 p-8 rounded-lg text-white h-auto bg-neutral-800 border-neutral-600'>
            ...
            <div className='flex flex-col pl-8'>
                ...
                <div className='mt-4 mb-4'>{movie.genres?.map((genre) => (
                    <span className="border-1 py-1 px-4 text-xs bg-neutral-700 border-neutral-500 rounded-lg mr-1" key={genre.id}>{genre.name} </span>
                ))}</div>
